    ...
    <div className="home-container">
      ...
      <div className="content">
        ...
        <div className="data-section">
          <button className="add-btn" onClick={() => navigate("/datahewan")}>
            Tambah Data Hewan
          </button>
              ...
              <tbody>
                {hewanData.map((hewan) => (
                  <tr key={hewan.id}>
                    ...
                    <td>
                      {hewan.gambar ? (
                        <img src={hewan.gambar || "/placeholder.svg"} alt={hewan.nama_hewan} className="table-image" />
                      ) : (
                        "No Image"
                      )}
                    </td>
                    <td>
                      <button className="edit-btn" onClick={() => navigate(`/datahewan/${hewan.id}`)}>
                        Edit
                      </button>
                      <button className="delete-btn" onClick={() => handleDeleteHewan(hewan.id)}>
                        Hapus
                      </button>
                    </td>
                  </tr>
        ...
        <div className="data-section">
          <button className="add-btn" onClick={() => navigate("/datapemilik")}>
            Tambah Data Pemilik
          </button>
              ...
              <tbody>
                {pemilikData.map((pemilik) => (
                  <tr key={pemilik.id}>
                    ...
                    <td>{pemilik.email}</td>
                    <td>
                      <button className="edit-btn" onClick={() => navigate(`/datapemilik/${pemilik.id}`)}>
                        Edit
                      </button>
                      <button className="delete-btn" onClick={() => handleDeletePemilik(pemilik.id)}>
                        Hapus
                      </button>
                    </td>
                  </tr>
